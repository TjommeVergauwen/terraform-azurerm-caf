resource "azurerm_private_dns_a_record" "a_records" {
  ...
  ttl                 = each.value.ttl
  records             = data.azurerm_app_service_environment_v3.ase.internal_inbound_ip_addresses //[data.azurerm_app_service_environment_v3.ase.internal_inbound_ip_addresses]
